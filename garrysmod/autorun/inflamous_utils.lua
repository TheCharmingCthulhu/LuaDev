...
function inflamous.UI:DrawTriangle(dist, vel, ang)
    ...
    local lfo3 = inflamous.TOOLS:MODULATE(3, angle + 180, velocity)
    ...
    surface.DrawLine(center.x + distance * lfo1[2], center.y + distance * lfo1[3], center.x + distance * lfo2[2], center.y + distance * lfo2[3])
    surface.DrawLine(center.x + distance * lfo2[2] - 16 % 10, center.y + distance * lfo2[3], center.x + distance * lfo3[2], center.y + distance * lfo3[3])
    surface.DrawLine(center.x + distance * lfo3[2] + 16, center.y + distance * lfo3[3], center.x + distance * lfo1[2], center.y + distance * lfo1[3])
end
...
function inflamous.TOOLS:MODULATE(index, offsetAngle, speed)
    ...
    inflamous.TOOLS.MODULATORS[index][1] = math.ceil(((inflamous.TOOLS.MODULATORS[index][1] + velocity) % 360))
    inflamous.TOOLS.MODULATORS[index][2] = math.cos(inflamous.TOOLS.MODULATORS[index][1] + offset)
    inflamous.TOOLS.MODULATORS[index][3] = math.sin(inflamous.TOOLS.MODULATORS[index][1] + offset)
