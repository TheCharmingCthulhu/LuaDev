...
function HUDPaint() 
    ...
    -- Crosshair
    inflamous.UI:DrawAlienaticSymbol(10, 0, crosshairAngle)
    inflamous.UI:DrawAlienaticSymbol(11, 0, crosshairAngle)
    inflamous.UI:DrawAlienaticSymbol(12, 0, crosshairAngle)
end
